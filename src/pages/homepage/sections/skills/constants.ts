...
export const SkillShapes: ShapeProps[] = [
  { type: Shape.RING, width: 200, color: ColorVariants.SECONDARY, position: { top: 30, left: 10 } },
  ...
  { type: Shape.SQUARE, width: 200, color: ColorVariants.PRIMARY, position: { top: 0, right: 7 } },
